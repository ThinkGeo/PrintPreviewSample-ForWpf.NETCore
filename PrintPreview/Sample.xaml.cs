...
namespace PrintPreview
{
    public partial class Sample : Window
    {
        ...
        private void btnZoomIn_Click(object sender, RoutedEventArgs e)
        {
            ...
            double newScale = ZoomLevelSet.GetLowerZoomLevelScale(MapUtil.GetScale(mapPrinterLayer.MapExtent, (float)mapPrinterLayer.GetBoundingBox().Width, mapPrinterLayer.MapUnit), zoomLevelSet);
        ...
        private void SetupComboBoxes()
        {
            ...
            {
                cbxPercentage.Items.Add($"{((PrinterZoomLevelSet)Map1.ZoomLevelSet).GetZoomPercentage(level):F0}%");
            }
        }
